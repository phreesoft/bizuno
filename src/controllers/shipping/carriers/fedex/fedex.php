...
define ('FEDEX_FREIGHT_METHODS',      '1DF,2DF,3DF,GDF,ECF,IFE,IFP'); // every freight service (Express 1/2/3 Day, LTL Priority/Economy, Int. Priority/Economy) tracks via the FedEx Freight portal
...
class fedex extends fedexCommon
{
    ...
    public function settingsStructure()
    {
        ...
        return [
            ...
            'dg_offeror'   => ['label'=>$this->lang['dg_offeror'],   'position'=>'after','attr'=>['size'=>48,'value'=>$this->settings['dg_offeror']]],
            'dg_phone'     => ['label'=>$this->lang['dg_phone'],     'position'=>'after','attr'=>['size'=>48,'value'=>$this->settings['dg_phone']]],
            'dg_signatory' => ['label'=>$this->lang['dg_signatory'], 'position'=>'after','attr'=>['size'=>48,'value'=>$this->settings['dg_signatory']]],
            'dg_sig_title' => ['label'=>$this->lang['dg_sig_title'], 'position'=>'after','attr'=>['size'=>48,'value'=>$this->settings['dg_sig_title']]],
            'dg_sig_place' => ['label'=>$this->lang['dg_sig_place'], 'position'=>'after','attr'=>['size'=>48,'value'=>$this->settings['dg_sig_place']]],
