...
$lang = [
    ...
    'msg_reset_link_inline_title' => 'Email is not configured on this site.',
    'msg_reset_link_failed_title' => 'Email could not be sent. (Mail config may be broken — check Settings → Mail.)',
    'msg_reset_link_inline_body' => 'Click the link below within 15 minutes to set a new password. Make a note of it for your records — the link works only once.',
